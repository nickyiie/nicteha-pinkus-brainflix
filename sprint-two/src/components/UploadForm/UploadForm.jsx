    ...
    <div>
      <form className='upload-form'>
        ...
        <div className='upload-form__input'>
          ...
          <input className='upload-form__titlebox' type='text' name='titlebox' placeholder='Add a title to your video'></input>
          <label className='upload-form__label'>ADD A VIDEO DESCRIPTION</label>
          <input className='upload-form__description' type='text' name='description' placeholder='Add a description of your video'></input>
        </div>
